        ...
        <div className="p-6 md:p-8">
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              className={`w-full mt-6 flex items-center justify-center gap-2 py-3 px-6 rounded-lg text-sm font-medium transition-all duration-300 shadow-md hover:shadow-lg ${
                isSubmitting
